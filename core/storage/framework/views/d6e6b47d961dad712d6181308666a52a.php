...
<head>
    ...
    <title><?php echo e(gs()->siteName($pageTitle ?? '500 | Server Error')); ?></title>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    <div class="error-500-thumb">
                        <img src="<?php echo e(asset('assets/errors/images/error-500.png')); ?>" alt="image">
                        <span class="error-500-thumb-cat">
                            <img src="<?php echo e(asset('assets/errors/images/cat.gif')); ?>" alt="image">
                        </span>
                    </div>

                    <h2 class="title"> <?php echo app('translator')->get('Sorry Internal server error'); ?></h2>
                    <p class="description"><?php echo app('translator')->get('Something went wrong on our end. We\'re working on fixing it.'); ?></p>
...
<?php /**PATH /home/pranjal/Pranjal/vscode/Files/core/resources/views/errors/500.blade.php ENDPATH**/ ?>